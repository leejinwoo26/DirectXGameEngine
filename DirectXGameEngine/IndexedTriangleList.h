...
public:
	...
	IndexedTriangleList(DXexp::VertexBuffer verts_in, std::vector<unsigned short> indices_in)
		:
	...
	{
		using Elements = DXexp::VertexLayout::ElementType;
	...
	void SetNormalsIndependentFlat()
	{
		...
		using Type = DXexp::VertexLayout::ElementType;
