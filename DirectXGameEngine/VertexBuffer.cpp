...
namespace Bind
{
	VertexBuffer::VertexBuffer(Graphics& gfx, const DXexp::VertexBuffer& vbuf)
		:
		VertexBuffer(gfx, "?", vbuf)
	{}
	VertexBuffer::VertexBuffer(Graphics& gfx, const std::string& tag, const DXexp::VertexBuffer& vbuf)
		:
